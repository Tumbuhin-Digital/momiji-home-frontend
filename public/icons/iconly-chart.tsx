...
export const IconlyChart = ({
  ...
  return (
    ...
    >
      <title>Iconly/Bold/Chart</title>
      <g
        id="Iconly/Bold/Chart"
        stroke="none"
        strokeWidth="1.5"
        fill="none"
        fillRule="evenodd"
