  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        className="primary-foreground absolute -inset-px flex items-center justify-center rounded-lg data-indeterminate:text-foreground data-checked:bg-primary data-unchecked:hidden"
