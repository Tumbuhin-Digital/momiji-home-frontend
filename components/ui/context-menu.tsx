    ...
    <ContextMenuPortal {...portalProps}>
      ...
      >
        <ContextMenuPrimitive.Popup
          className={cn(
            "relative flex origin-(--transform-origin) rounded border bg-popover shadow-lg/5 outline-none not-dark:bg-clip-padding not-[class*='w-']:min-w-32 before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] focus:outline-none dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
            className
          )}
