...
export function ProductCatalogCardSkeleton() {
  return (
    <Card className="flex h-auto min-h-23.75 w-full flex-row items-stretch gap-3 overflow-hidden rounded border-none bg-card p-3 transition-all duration-300">
      {/* Image */}
      ...
      <div className="flex flex-1 flex-col justify-center gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center justify-between gap-3 sm:justify-end">
          ...
          <div className="flex items-center justify-end">
            <Skeleton className="h-9 w-27 rounded sm:w-32.5" />
          </div>
        </div>
      </div>
    </Card>
